    ...
    <div className="flex flex-col min-h-screen">
      <div className="max-w-4xl mx-auto w-full px-6 py-12">
                ...
                <div className="grid md:grid-cols-2 gap-10">
                  ...
                  <div className="group p-10 border-2 border-black dark:border-white hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors relative overflow-hidden">
                    <span className="font-black block text-xs uppercase mb-4 text-zinc-500 tracking-widest flex items-center gap-2">
                      ...
                      {t("privacy.sidePanel_title")}
                    </span>
                    <p className="text-zinc-900 dark:text-zinc-100 font-bold text-xl leading-snug">
                      {t("privacy.sidePanel_desc")}
                    </p>
                  </div>
                  <div className="group p-10 border-2 border-black dark:border-white hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors relative overflow-hidden">
                    <span className="font-black block text-xs uppercase mb-4 text-zinc-500 tracking-widest flex items-center gap-2">
                  ...
                  <div className="group p-10 border-2 border-black dark:border-white hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors relative overflow-hidden md:col-span-2">
                    ...
                    <p className="text-zinc-900 dark:text-zinc-100 font-bold text-xl leading-snug">
                      {t("privacy.systemDisplay_desc")}
                    </p>
                  </div>
                  <div className="group p-10 border-2 border-black dark:border-white hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors relative overflow-hidden md:col-span-2">
                    <span className="font-black block text-xs uppercase mb-4 text-zinc-500 tracking-widest flex items-center gap-2">
                      <Monitor className="w-4 h-4" />{" "}
                      {t("privacy.webNavigation_title")}
                    </span>
                    <p className="text-zinc-900 dark:text-zinc-100 font-bold text-xl leading-snug">
                      {t("privacy.webNavigation_desc")}
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="space-y-6">
                        <p className="font-bold text-lg md:text-xl leading-relaxed">
                          The chatbot is now a command-based system and does not
                          utilize AI or third-party APIs.
                        </p>
                        <p className="font-bold text-sm opacity-70 border-t border-zinc-800 dark:border-zinc-200 pt-6">
                          This ensures complete privacy and local processing.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 p-8 bg-black text-white dark:bg-white dark:text-black space-y-4">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-black uppercase text-sm">
                        {t("privacy.issues_title")}
                      </span>
                    </div>
                    <p className="font-bold opacity-80">
                      {t("privacy.issues_desc")}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="reveal-on-scroll pt-16 border-t-8 border-black dark:border-white">
                ...
                <div className="premium-card p-12 bg-black text-white dark:bg-white dark:text-black flex flex-col md:flex-row justify-between items-center gap-8">
                  <div className="space-y-4 text-center md:text-left">
                    <p className="text-zinc-400 dark:text-zinc-600 font-black uppercase text-xs tracking-[0.3em]">
        ...
        <footer className="text-center py-20 border-t-2 border-black dark:border-white opacity-40 text-[10px] font-black uppercase tracking-[0.5em] reveal-on-scroll">
          &copy; {year} PRIVACY BOOKMARK. {t("privacy.rights")}
        </footer>
      </div>
    </div>
  )
